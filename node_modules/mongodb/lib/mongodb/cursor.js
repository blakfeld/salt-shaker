...
Cursor.prototype.nextObject = function (options, callback) {
    ...
    if (self.state == Cursor.INIT) {
        ...
        var queryOptions = {exhaust: self.exhaust, raw: self.raw, read: self.read, connection: self.connection, checkKeys: false};
...
Cursor.prototype.explain = function (callback) {
    ...
    var cursor = new Cursor(this.db, this.collection, this.selector, this.fields, {
        skip: this.skipValue, limit: limit, sort: this.sortValue, hint: this.hint, explain: true, snapshot: this.snapshot, timeout: this.timeout, tailable: this.tailable, batchSize: this.batchSizeValue, slaveOk: this.slaveOk, raw: this.raw, read: this.read, returnKey: this.returnKey, maxScan: this.maxScan, min: this.min, max: this.max, showDiskLoc: this.showDiskLoc, comment: this.comment, awaitdata: this.awaitdata, oplogReplay: this.oplogReplay, numberOfRetries: this.numberOfRetries, dbName: this.dbName
    });
