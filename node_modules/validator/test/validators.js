...
describe('Validators', function () {
    ...
    it('should validate alphanumeric strings', function () {
        test({
            validator: 'isAlphanumeric', valid: [
                'abc123'
                , 'ABC11'
            ], invalid: [
                'abc '
    ...
    it('should validate that integer strings are divisible by a number', function () {
        test({
            validator: 'isDivisibleBy', args: [ 2 ], valid: [ '2', '4', '100', '1000' ], invalid: [
                '1'
                , '2.5'
                , '101'
                , 'foo'
    ...
    it('should validate ISBNs', function () {
        test({
            validator: 'isISBN', args: [ 10 ], valid: [
        ...
        test({
            validator: 'isISBN', args: [ 13 ], valid: [
        ...
        test({
            validator: 'isISBN', args: [ 'foo' ], invalid: [
                '340101319X'
                , '9784873113685'
            ]
        });
