$(document).ready(function(){
  ...
  var current_minion = location.pathname.substring(location.pathname.lastIndexOf("/") + 1);

  // Requst intial minion list
    ...
    if(data.grains) {
      ...
      for (key in grains) {
        ...
        if (typeof(grains[key]) !== 'object') {
          html += "<p class='list-group-item-text'><ul><li>" + grains[key] + "</li></ul></p>";
          ...
          for (var i = 0; i < grains[key].length; i++) {
            ...
            if (typeof(grains[key][i]) !== 'object') {
              ...
              for (subkey in grains[key][i]) {
                html += "<li><b>" + subkey + ": </b>" + grains[key][i][subkey] + "</li>";
              }
            }
          }
          html += "</ul>"
        ...
        // Assume its a Dictionary
          ...
          for (subkey in grains[key]) {
            html += "<li><b>" + subkey + ": </b>" + grains[key][subkey] + "</li>";
          }
          html += "</ul>"
        }
        html += "</li>"
